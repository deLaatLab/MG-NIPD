...
wd <- paste("/data1/projects/nipd/pipeline/processed_data/family", familynr, sep="")
root <- wd
fams <- paste(familynr, "_CFTR", sep="")
family <- fams
dad <- paste("family", familynr, "_D_TLA_CFTR", sep="")
mom <- paste("family", familynr, "_M_TLA_CFTR", sep="")
#cfDNA <- paste("/cfDNA/cfDNA", familynr, "_nextseq_RMCO.vcf", sep="")

cfDNA <- paste("/cfDNA/family", familynr, "_cfDNA.RMCO_Q0_19-1.vcf", sep="")

CVSfile <- paste("~/RHDO/Standard/Family", familynr, "/CVS",familynr,".vcf", sep="")


dadtla <- paste("/haplotypes/", dad, ".vcf", sep="")
momtla <- paste("/haplotypes/", mom, ".vcf", sep="")

mhap1 <- paste("/haplotypes/", mom, "_lenient_NSver.1.5.hap1.txt", sep="")
mhap2 <-  paste("/haplotypes/", mom, "_lenient_NSver.1.5.hap2.txt", sep="")
phap1 <- paste("/haplotypes/", dad, "_lenient_NSver.1.5.hap1.txt", sep="")
phap2 <- paste("/haplotypes/", dad, "_lenient_NSver.1.5.hap2.txt", sep="")
...
write.table(type_1, file=paste(wd,"/family_", fams,"_type1.txt", sep=""), quote=F, row.names=F)
...
write.table(type_3, file=paste(wd,"/family_", fams,"_type2.txt", sep=""), quote=F, row.names=F)
...
write.table(RHDOlist, file=paste(wd, "/family_",fams,"_RHDO.txt", sep=""), quote=F, row.names=F)
